...
This fork tracks an upstream release and carries the sticky floating-window
feature from [upstream PR #2083](https://github.com/nikitabobko/AeroSpace/pull/2083).
